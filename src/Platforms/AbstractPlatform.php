...
use Corma\DBAL\Exception\InvalidColumnType\ColumnPrecisionRequired;
use Corma\DBAL\Exception\InvalidColumnType\ColumnScaleRequired;
use Corma\DBAL\LockMode;
use Corma\DBAL\Platforms\Exception\NoColumnsSpecifiedForTable;
