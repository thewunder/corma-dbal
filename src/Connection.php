...
use Corma\DBAL\Cache\Exception\NoResultDriverConfigured;
...
use Corma\DBAL\Exception\CommitFailedRollbackOnly;
use Corma\DBAL\Exception\ConnectionLost;
use Corma\DBAL\Exception\DriverException;
use Corma\DBAL\Exception\NoActiveTransaction;
use Corma\DBAL\Exception\SavepointsNotSupported;
